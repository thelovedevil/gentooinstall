...
print_curses("hajime <: press enter >")

for key, value in lvcreate_swap_prefab.items():
                        if value == "null":
                                lvcreate_swap_prefab[key]=input()
...
for key, value in lvcreate_root_prefab.items():
                        if value == "null":
                                lvcreate_root_prefab[key]=input()
...
print_curses("lastly we will fill in our home diretory. <: press enter > ")
