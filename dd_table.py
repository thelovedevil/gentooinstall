...
def dd_options_digest(stdscr, printer: CursedPrinter, sources):
    x = 0
...
if __name__ == "__main__":
    def main_curses(stdscr):
        ...
        printer.display_text(["Loading DD options..."])
        sources = test_dd_options() # Call the utility function from utils
        
        selected_options = dd_options_digest(stdscr, printer, sources)
