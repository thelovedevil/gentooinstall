...
-l: --keyfile-size=bytes           
    --keyslot-cipher=STRING        
    ...
    --volume-key-file=STRING       
    --new-keyfile=STRING           
    --new-key-slot=INT             
                                   
    --new-keyfile-offset=bytes     
...
-r: --readonly                     
    --reduce-device-size=bytes     
                                   
    --refresh                      
                                   
    --resilience=STRING            
                                   
    --resilience-hash=STRING       
    --resume-only                  
