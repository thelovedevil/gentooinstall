...
from utils import test_gpg_options # Import the utility function
...
def gpg_options_digest(stdscr, printer: CursedPrinter, sources):
    x = 0
...
if __name__ == "__main__":
    def main_curses(stdscr):
        ...
        printer.display_text(["Loading GPG options..."])
        sources = test_gpg_options() # Call the utility function from utils
        
        selected_options = gpg_options_digest(stdscr, printer, sources)
